...
export default function AddProductPage({token}) {
   ...
   return (
      <form onSubmit={handleSubmit}
         ...
         <div>
            <p className='mb-2 capitalize font-semibold'>Upload Image</p>
         ...
         <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
               <p className='mb-2 capitalize font-semibold'>Product category</p>
            ...
            <div>
               <p className='mb-2 capitalize font-semibold'>Sub category</p>
            ...
            <div>
               <p className='mb-2 capitalize font-semibold'>Product Price</p>
         ...
         <div>
            <p className='mb-2 capitalize font-semibold'>Product Sizes</p>
         ...
         <div className='flex gap-2 mt-2'>
            ...
            <label className='cursor-pointer capitalize font-semibold' htmlFor="bestseller">Add to
               bestseller</label>
         </div>

         <button type="submit" className='w-56 py-3 mt-4 rounded-md uppercase font-semibold bg-black text-white'>Add Product
         </button>
      </form>
   );
}