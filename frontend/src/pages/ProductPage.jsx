         ...
         <div
            ...
            <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
               ...
               <div className='flex-1'>
                  <h2 className='font-medium tracking-wider text-2xl mt-2'>{productData.name}</h2>
                  ...
                  <p className='mt-5 tracking-wider text-gray-500 md:w-4/5'>{productData.description}</p>
                  <div className='flex flex-col tracking-wider gap-4 my-8'>
                     <p>Select Size</p>
                  ...
                  <div className='text-sm text-gray-500 mt-5 flex flex-col tracking-wider gap-1'>
            ...
            <div className='mt-20'>
               <div className='flex'>
                  <b className='border px-5 tracking-wider py-3 text-sm'>Description</b>
                  <p className='border px-5 tracking-wider py-3 text-sm'>Reviews (122)</p>
               </div>
               <div
                  className='flex flex-col tracking-wider gap-4 border px-6 py-6 text-sm text-gray-500'>
